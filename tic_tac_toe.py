...
if (opponent == "Player"):
    ...
    while (game_is_over != True):
        player1_turn = input(player1_turn_message)
        player1_turn_validation = player1_turn in tbr and player1_turn != "".strip()
        while (player1_turn_validation):
            if player1_turn_validation:
                tbr = list(map(lambda x: x.replace(player1_turn, 'O'), tbr))
                print(tbr)
        ...
        player2_turn_validation = player2_turn in tbr and player2_turn != "".strip()
        while (player2_turn_validation):
            if player2_turn_validation:
